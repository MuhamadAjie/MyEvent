...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="/eo_home" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>E</b>O</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Event</b>Organizer</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">Al-Akadar Studio</a>.</strong> All rights
    reserved.
  </footer>
